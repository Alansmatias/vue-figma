<template>
    <div class="menu-Bottom">
        <!-- Conteúdo do botão -->
         <div class="item">
            <svg class="menu-icon" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" viewBox="0 0 24 24">
            <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/>
            </svg>
         </div>
         <div class="item">
            <svg class="menu-icon" xmlns="http://www.w3.org/2000/svg" width="50" height="40" fill="currentColor" viewBox="0 0 384 512">
